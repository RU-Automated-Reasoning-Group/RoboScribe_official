...
@register_env("OpenCabinetDrawerCube2ArmToppanel-v1", max_episode_steps=400)
class OpenCabinetDrawerCube2ArmToppanelEnv(OpenCabinetEnv):
    ...
    def __init__(self, task: str = "opendrawer",extract: str="None", *args,  **kwargs):
        self.task = task
    ...
    def _load_actors(self):
        ...
        self.cubeB = self._build_cube(self.cube_half_size, color=(0, 1, 0), name="cubeB", static=False)
    ...
    def _initialize_actors(self):
        ...
        radius = np.linalg.norm(self.cube_half_size[:2]) + 0.01
    ...
    def check_cube_in_drawer(self, cube):
        ...
        # height [0.67, 0.69]
        threshold = np.array([0.19,0.14,0.015])
